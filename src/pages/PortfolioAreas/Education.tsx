...
const educationExperiences: Experience[] = [
  {
    ...
    xpTime: `2019 - 2021 - ${TimeCalculator.calculatePeriod(ExperiencesTime.tiGrad.init, ExperiencesTime.tiGrad.end)}`
  },
  {
    companyClass: 'senac',
    companyName: 'Centro Universitário Senac',
    ...
    xpTime: `2017 - 2018 - ${TimeCalculator.calculatePeriod(ExperiencesTime.multGrad.init, ExperiencesTime.multGrad.end)}`
  },
  {
    ...
    xpTime: `2022 - 2023 - ${TimeCalculator.calculatePeriod(ExperiencesTime.mobPos.init, ExperiencesTime.mobPos.end)}`
  },
]
